...
let PictureService = class PictureService {
    constructor(picturesRepository, userService) {
        this.picturesRepository = picturesRepository;
        this.userService = userService;
    }
    async uploadFile(createPictureDto, userId, fileName) {
        if (userId) {
...
PictureService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(picture_entity_1.Picture)),
